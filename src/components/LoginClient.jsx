      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-white border border-[#1A6FBF]/20 rounded-3xl shadow-[0_20px_60px_rgba(26,111,191,0.12)] p-8">
          <div className="text-center mb-8">
            <h2 className="text-4xl font-black text-[#1A6FBF]">
              Login
            </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="input input-bordered w-full rounded-2xl bg-white border-black/10 focus:outline-none focus:border-[#3FA9D4] text-black focus:bg-white transition-all duration-300"
                required
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="input input-bordered w-full text-black rounded-2xl bg-[#F4F9FD] border-black/10 focus:outline-none focus:border-[#3FA9D4] focus:bg-white transition-all duration-300"
                required
              />
            </div>
            ...
            <div className="divider px-3 py-6 text-sm text-gray-400">
              OR
            </div>
